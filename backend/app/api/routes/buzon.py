...
from app.buzon.ingesta import BuzonError, leer_cifrado
...
from app.tasks.buzon import ingerir_correo
...
def descargar_xml(
    ...
    _exigir_bandeja(db, tenant_id)
    if not retenciones.activo(db):
        # El interruptor cubre TODAS las rutas del módulo, no solo el listado
